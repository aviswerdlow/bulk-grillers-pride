...
export const CommandDialog = ({ children, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
...
>(({ className, ...props }, ref) => (
  <input ref={ref} type="text" data-testid="command-input" className={className} {...props} />
));
CommandInput.displayName = 'CommandInput';

export const CommandList = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, children, ...props }, ref) => (
    <div ref={ref} role="listbox" data-testid="command-list" className={className} {...props}>
      {children}
    </div>
  )
);
...
export const CommandEmpty = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => <div ref={ref} data-testid="command-empty" {...props} />
);
CommandEmpty.displayName = 'CommandEmpty';

export const CommandGroup = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, children, ...props }, ref) => (
    <div ref={ref} role="group" data-testid="command-group" className={className} {...props}>
      {children}
    </div>
  )
);
...
export const CommandShortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
  return <span data-testid="command-shortcut" className={className} {...props} />;
};
